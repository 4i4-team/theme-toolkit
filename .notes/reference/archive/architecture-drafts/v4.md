...
- subsystem-specific normalization hooks
...
- connect shared property normalization with subsystem-specific normalization
...
- `theme.ts`
  - composition layer that connects local logic with shared infrastructure
