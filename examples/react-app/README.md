...
- **No CSS-in-JS dependency** — demonstrates that the toolkit works with plain class names. The same pattern works with any framework (Angular, Vue, Svelte, plain HTML).
